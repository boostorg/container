...
namespace container {
   ...
   {
      BOOST_ASSERT(false && "boost::container bad_alloc thrown");
      std::abort();
   }
   ...
   BOOST_NORETURN inline void throw_out_of_range(const char* str)
   {
      ...
      BOOST_ASSERT_MSG(false && "boost::container out_of_range thrown", str);
      std::abort();
   }
   ...
   {
      boost::container::ignore(str);
      BOOST_ASSERT_MSG(false && "boost::container length_error thrown", str);
      std::abort();
   }
   ...
   {
      boost::container::ignore(str);
      BOOST_ASSERT_MSG(false && "boost::container logic_error thrown", str);
      std::abort();
   }
   ...
   {
      boost::container::ignore(str);
      BOOST_ASSERT_MSG(false && "boost::container runtime_error thrown", str);
      std::abort();
   }
   ...
   //!   is NOT defined <code>BOOST_ASSERT(false && "boost::container bad_alloc thrown")</code> is called
   ...
   //!
   //! <li>If BOOST_NO_EXCEPTIONS is defined and BOOST_CONTAINER_USER_DEFINED_THROW_CALLBACKS
   //!   is NOT defined <code>BOOST_ASSERT_MSG(false && "boost::container out_of_range thrown", str)</code> is called
   //!   and <code>std::abort()</code> if the former returns.</li>
   //!
   //! <li>If BOOST_NO_EXCEPTIONS and BOOST_CONTAINER_USER_DEFINED_THROW_CALLBACKS are defined
   //!   the user must provide an implementation and the function should not return.</li>
   ...
   //!
   //! <li>If BOOST_NO_EXCEPTIONS is defined and BOOST_CONTAINER_USER_DEFINED_THROW_CALLBACKS
   //!   is NOT defined <code>BOOST_ASSERT_MSG(false && "boost::container length_error thrown", str)</code> is called
   //!   and <code>std::abort()</code> if the former returns.</li>
   //!
   //! <li>If BOOST_NO_EXCEPTIONS and BOOST_CONTAINER_USER_DEFINED_THROW_CALLBACKS are defined
   //!   the user must provide an implementation and the function should not return.</li>
   ...
   //!
   //! <li>If BOOST_NO_EXCEPTIONS is defined and BOOST_CONTAINER_USER_DEFINED_THROW_CALLBACKS
   //!   is NOT defined <code>BOOST_ASSERT_MSG(false && "boost::container logic_error thrown", str)</code> is called
   //!   and <code>std::abort()</code> if the former returns.</li>
   //!
   //! <li>If BOOST_NO_EXCEPTIONS and BOOST_CONTAINER_USER_DEFINED_THROW_CALLBACKS are defined
   //!   the user must provide an implementation and the function should not return.</li>
   ...
   //!
   //! <li>If BOOST_NO_EXCEPTIONS is defined and BOOST_CONTAINER_USER_DEFINED_THROW_CALLBACKS
   //!   is NOT defined <code>BOOST_ASSERT_MSG(false && "boost::container runtime_error thrown", str)</code> is called
   //!   and <code>std::abort()</code> if the former returns.</li>
   //!
   //! <li>If BOOST_NO_EXCEPTIONS and BOOST_CONTAINER_USER_DEFINED_THROW_CALLBACKS are defined
   //!   the user must provide an implementation and the function should not return.</li>
