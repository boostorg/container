    ...
    segmented_iterator_tag, SrcCat)
{
   ...
   if(sfirst == slast) {
      segduo<SrcIter, dst_local_iterator> r = (segmented_swap_ranges_dst_bounded)
      ...
      for(++sfirst; sfirst != slast; ++sfirst) {
         r = (segmented_swap_ranges_dst_bounded)
...
FwdIt2 segmented_swap_ranges_dispatch (SegIter first1, SegIter last1, FwdIt2 first2, segmented_iterator_tag, Cat)
{
   ...
   if(sfirst == slast) {
      return (segmented_swap_ranges_dispatch)
         (src_traits::local(first1), src_traits::local(last1), first2, src_is_local_seg_t(), src_local_cat_t());
   }
   else {
      first2 = (segmented_swap_ranges_dispatch)
         (src_traits::local(first1), src_traits::end(sfirst), first2, src_is_local_seg_t(), src_local_cat_t());
      ...
      return (segmented_swap_ranges_dispatch)
         (src_traits::begin(slast), src_traits::local(last1), first2, src_is_local_seg_t(), src_local_cat_t());
   }
}
