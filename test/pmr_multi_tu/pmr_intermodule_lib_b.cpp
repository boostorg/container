...
//
//////////////////////////////////////////////////////////////////////////////
//Shared library "B" of the pmr intermodule test: inlines its own copy of the
...
BOOST_SYMBOL_EXPORT void *lib_b_allocate_from_default(std::size_t bytes, std::size_t align)
{  return bc::pmr::get_default_resource()->allocate(bytes, align);  }

BOOST_SYMBOL_EXPORT void lib_b_deallocate_from_default(void *p, std::size_t bytes, std::size_t align)
