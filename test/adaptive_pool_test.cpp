...
int main ()
{
   ...
   if(test::extended_pool_allocator_test<adapt_node_allocator_t>("adaptive_pool<int>"))
      return 1;
   if(test::extended_pool_allocator_test< adaptive_pool<double> >("adaptive_pool<double>"))
      return 1;
